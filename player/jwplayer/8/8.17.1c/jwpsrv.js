...
function() {
    ...
    function(e) {
        ...
        t = Array(1 < a ? a - 1 : 0), n = 1; n < a; n++) t[n - 1] = arguments[n];
    ...
    function s(e) {
        var a = {};
        for (var t in e) if ("object" == typeof e[t]) {
            var n = s(e[t]);
    ...
    function ve(e, a) {
        var t, n, r, i, o, d, l, u;
        for (t = 3 & e.length, n = e.length - t, r = a, o = 3432918353, d = 461845907, u = 0; u < n;) l = 255 & e.charCodeAt(u) | (255 & e.charCodeAt(++u)) << 8 | (255 & e.charCodeAt(++u)) << 16 | (255 & e.charCodeAt(++u)) << 24,
        ++u,
    ...
    function Ie(e, a) {
        ...
        var n = t || a.externalId; (e.playlistItemData.externalId = n) && !e.meta.xidAlgorithmVersion && (e.meta.xidAlgorithmVersion = 0)
    }
    var Te = "hidden" in document ?
    function() {
    ...
    function Me(e, a, t) {
        ...
        e.playlistItemData.duration = w(e),
        e.meta.lastEvent = a,
        e.meta.lastBucket = t,
        ...
        o = a,
        d = t,
        -1 === Re.indexOf(o) && (i.meta.eventPreAbandonment = u(o, d))
    }
    var Ve = {
        prs: function(e) {
    ...
    $e.cct = function(e) {
        ...
        Array.prototype.some.call(a.tracks || 0,
        function(e) {
            var a = e.kind;
    ...
    na = function(e, a, t, n) {
        ...
        r.forEach(function(e) {
            var a = e.value; ! 0 !== a && !1 !== a || (a = a ? 1 : 0),
            null != a && i.push(e.code + "=" + encodeURIComponent(a))
        });
    ...
    function ia(e) {
        var a = e.external.playerAPI,
        t = "complete" === (a.getContainer().ownerDocument || window.document).readyState; (e.trackingState.pageLoaded = t) || (e.trackingState.boundFlushQueue = ra.bind(null, e), window.addEventListener && window.addEventListener("load", e.trackingState.boundFlushQueue), setTimeout(e.trackingState.boundFlushQueue, 5e3))
    }
    function oa(e, a) {
        var t = a.event,
        n = a.bucket,
    ...
    function da(e, a) {
        ...
        t.src = a + "&" + ie + "=" + n;
        for (var r = e.trackingState.images,
        i = r.length; i--&&(r[i].width || r[i].complete);) r.length = i;
    ...
    function ca(e) {
        ...
        e.bidders.forEach(function(e) {
            var t, n, a = e.name;
            r[a.toLowerCase()] = (t = e, n = {},
            N.forEach(function(e) {
                var a;
                "result" === e ? n.result = D[t[e]] : B(n, void 0 !== t[e] ? ((a = {})[e] = t[e], a) : void 0),
    ...
    function sa(t, e) {
        var n = t.ads.adEventData; - 1 === t.ads.adClient && e && (t.ads.adClient = M(e.client)),
    ...
    var ya = {
        ...
        adError: function(e, a) {
            "object" == typeof a && a && (e.playerData.lastErrorCode.ae = a.code || 1, e.ads.jwAdErrorCode = a.adErrorCode, 51901 === a.adErrorCode ? e.ads.errorMessage = "string" == typeof a.message ? a.message.substring(0, 100) : void 0 : e.ads.errorMessage = void 0, e.ads.timeout = a.timeout),
            ua(e, "ae", "clienta")
        },
        adTime: function(e, a) {
            var t = e.ads.adEventData,
            ...
            i = e.ads.pingLimiters; ! n || t.position > t.duration || (function(e, a, t) {
                var n = ga(a, t),
    ...
    function ba(i) {
        ...
        function() {
            ma(i, "ad-break"),
            i.ads.adBreakTracking && i.ads.adBreakTracking.shouldTrack && (i.ads.adBreakTracking.shouldTrack = !1, i.ads.adBreakTracking.adBreakCount++)
        }),
        e.on("adClick adRequest adMeta adImpression adComplete adSkipped adError adTime adBidRequest adBidResponse adStarted adLoaded adViewableImpression adBreakEnd",
        function(e) {
            var a, t, n, r = i.ads.adEventData;
            a = r,
            "adClick" === (t = e).type || a && a.adId === t.id && -1 !== t.id || (i.ads.adEventData = B({
                adId: e.id
            },
            G), i.ads.pingLimiters.visibleEvent.resetAll(), i.ads.adPlaybackTracking = B({},
            S)),
            n = e,
            -1 === E.indexOf(n.type) && sa(i, e),
            e.type in ya ? ya[e.type](i, e) : -1 === P.indexOf(e.type) && ua(i, T[e.type], "clienta")
        })
    }
    function ha(a) {
        function e() {
        ...
        a.external.playerAPI.on("remove",
        function() {
            g(a, Z),
    ...
    function Ca(d, l) {
        return function(e) {
            ...
            a[l] = e,
            l === Ta && (i || (n.playedSeconds = 0, n.viewablePlayedSeconds = 0, n.audiblePlayedSeconds = 0, n.playedSecondsTotal = 0), n.previousTime = h(r)),
            l === Pa && (g(d, Q), "flash_adaptive" === m(r) ? !d.meta.playbackSent && n.segmentReceived && (d.meta.playbackSent = !0, n.segmentReceived = !1, Ea(d)) : d.meta.playbackSent || (d.meta.playbackSent = !0, Ea(d)))
        }
    }
    function Aa(e) {
    ...
    function ja(e, a, t) {
        ...
        r = t,
        i = o,
        e.meta.pingLimiters.playlistItem.canSendPing(i) && Math.floor(n) === r && (e.meta.playbackTracking.thresholdCrossed = t, ua(e, K), e.meta.pingLimiters.playlistItem.setPingSent(o))
    }
    function Ba(e, a, t) {
        var n, r;
    ...
    function Ra(e, a, t) {
        ...
        e.errors.numberEventsSent < e.errors.NUM_ERRORS_PER_SESSION && (r = a, "number" == typeof(n = e).playerData.lastErrorCode[r] || Math.random() < n.errors.SAMPLE_RATE) && (e.errors.numberEventsSent += 1, ua(e, a, U))
    }
    var Ma = n,
    Va = t,
    La = a,
    ...
    function Fa(g) {
        ...
        v.on("idle buffer play pause complete error",
        function(e) {
            ma(g, e.type)
        }),
        v.on("idle", Oa.bind(null, g)),
        v.on("ready",
        function(e) {
            g.playlistItemData.ready = B({},
            e),
            g.playerData.viewable = v.getViewable(),
            g.playerData.muted = v.getMute(),
            g.playerData.volume = v.getVolume();
            try {
        ...
        function(e) {
            ...
            a.drm = "",
            0 !== g.meta.playbackTracking.playSessionSequence && (a.itemId = R(12)),
            g.meta.playbackTracking.playSessionSequence++,
            a.index = e.index;
            var t, n, r = e.item || f(v);
            r && (a.mediaId = we(r), Ie(g, r)),
            a.ready && (g.meta.playbackTracking.posterVideoThumbnail = Se(e.item), t = g, n = a.ready, t.playerData.setupTime = -1, n && n.setupTime && (t.playerData.setupTime = 10 * Math.round(n.setupTime / 10) | 0), ua(t, "e"), a.item = null, a.ready = null),
            v.off("beforePlay", i),
            v.once("beforePlay", i),
            Oa(g),
            g.meta.playbackTracking.segmentReceived = g.meta.playbackTracking.segmentsEncrypted = !1
        }),
        v.on("playAttemptFailed", t),
        v.on("meta", Ca(g, La)),
        v.on("levels", Ca(g, Va)),
        v.on("play", Ca(g, Ga)),
        v.on("firstFrame", Ca(g, Ma)),
        v.on("time",
        function(e) {
            ...
            t.currentPosition = n;
            var r = e.duration;
            if (n) if (g.meta.seekTracking.dragStartTime) t.previousTime = n;
            else {
                1 < n && (a[Va] || Ca(g, Va)({}));
                var i, o, d, l = Ke(r),
        ...
        function(e) {
            ...
            k = a,
            t && -1 === r.indexOf(n.reason) && ua(g, "vqc")
        }),
        v.on(o.join(" "),
        function() {
            g.ads.adBreakTracking && (g.ads.adBreakTracking.shouldTrack = !0)
        }),
        v.on("error", Ra.bind(null, g, pe)),
        v.on("setupError", Ra.bind(null, g, se)),
        v.on("autostartNotAllowed",
        function() {
            ua(g, _)
        }),
        v.on("viewable",
        ...
        v.on("captionsChanged",
        function(e) {
            0 !== e.track && 0 === g.playerData.captionsIndex && ua(g, ae),
            g.playerData.captionsIndex = e.track
        }),
        v.on("videoThumbFirstFrame",
        function(e) {
        ...
        Oa(g),
        a = z,
        (e = g).meta.previousBufferTimes[a] = We(e)
    }
    function Na(e, a) {
        ...
        e.related.pinSetId = he(a.target),
    ...
    function Ua(a) {
        ...
        function(e) {
            qa(a, e, X)
        }), e.on("feedAutoAdvance",
        function(e) {
            qa(a, e, Y)
        }), e.on("videoThumbFirstFrame",
        function(e) {
            a.meta.playbackTracking.overlayVideoThumbAnimated = !0
        }), a.related.relatedSetUp = !0)
    }
    function Qa(t) {
        t.external.playerAPI.getPlugin && (t.external.playerAPI.on("ready",
        function() {
            var a, e;
            Ua(t),
            (e = (a = t).external.playerAPI).on("playlistItem",
            function() {
            ...
            function(e) {
                ...
                a.related.shownReason = e.reason,
                ma(a, "recs-overlay"),
                "hover" === e.reason && !a.related.sendHoverPing || (a.related.sendHoverPing = !1, qa(a, e, J))
            }),
            e.on("nextClick",
            function(e) {
                a.related.nextShownReason && qa(a, e, X)
            }),
            e.on("nextAutoAdvance",
            function(e) {
                qa(a, e, Y)
            })
        }), t.external.playerAPI.on("relatedReady",
        function() {
    ...
    function Ka(e) {
        var a;
        a = e,
        "function" == typeof navigator.sendBeacon && ha(a),
        Fa(e),
        ba(e),
        Qa(e),
        za(e)
    ...
    function nt(e, a, t) {
        ...
        return {
            ...
            accountData: function(e, a) {
                ...
                if (e) {
                    var r = new a(e),
                    i = r.edition(); (t = A[i] || 0) !== C && (n = r.token())
                }
                return {
                    analyticsID: n = n || "_",
                    edition: t
            ...
            configData: (h = i, w = window.jwplayer && window.jwplayer.defaults || {},
            D = h.related, S = {
    ...
    var rt = 0; (window.jwplayerPluginJsonp || window.jwplayer().registerPlugin)("jwpsrv", "7.0",
    function(e, a, t) {
        var r, i = nt(e, a, t);
        Ka(i),
        ia(i),
